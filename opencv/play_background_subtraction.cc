 ...
 *
 * g++ -std=c++11 -Wall -g play_background_subtraction.cc -lopencv_core
 * -lopencv_cudabgsegm -lopencv_imgcodecs -o play_background_subtraction
 */
...
cv::Mat zero_frame() { return cv::Mat(1, 1, CV_8UC3, cv::Scalar(0)); }
